...
namespace Czar.Cms.Core.CodeGenerator
{
    ...
    public class CodeGenerator
    {
        ...
        {
            var modelPath = _options.OutputPath + Delimiter+ "Czar.Cms.Models";
        ...
        {
            var iRepositoryPath = _options.OutputPath + Delimiter + "Czar.Cms.IRepositonry";
        ...
        {
            var repositoryPath = _options.OutputPath + Delimiter + "Czar.Cms.Repository.SqlServer";
        ...
        {
            var iServicesPath = _options.OutputPath + Delimiter + "Czar.Cms.IServices";
        ...
        {
            var repositoryPath = _options.OutputPath + Delimiter + "Czar.Cms.Services";
            if (!Directory.Exists(repositoryPath))
            {
                Directory.CreateDirectory(repositoryPath);
            }
        ...
        private string ReadTemplate(string templateName)
        {
            ...
            var tempath = $"Czar.Cms.Core.CodeTemplate.{templateName}";
            using (var stream = currentAssembly.GetManifestResourceStream(tempath))
            {
                if (stream != null)
                {
