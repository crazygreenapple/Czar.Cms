        ...
        for(var i=0;i<data.length;i++){
            ...
            if(data[i].children != undefined && data[i].children.length > 0){
                ...
                if(data[i].ImgUrl != undefined && data[i].ImgUrl != ''){
                    if(data[i].ImgUrl.indexOf("icon-") != -1){
                        ulHtml += '<i class="seraph '+data[i].ImgUrl+'" data-icon="'+data[i].ImgUrl+'"></i>';
                    }else{
                        ulHtml += '<i class="layui-icon" data-icon="'+data[i].ImgUrl+'">'+data[i].ImgUrl+'</i>';
                    }
                }
                ...
                for(var j=0;j<data[i].children.length;j++){
                    if(data[i].children[j].target == "_blank"){
                        ulHtml += '<dd><a data-url="'+data[i].children[j].LinkUrl+'" target="'+data[i].children[j].target+'">';
                    }else{
                        ulHtml += '<dd><a data-url="'+data[i].children[j].LinkUrl+'">';
                    }
                    if(data[i].children[j].ImgUrl != undefined && data[i].children[j].ImgUrl != ''){
                        if(data[i].children[j].ImgUrl.indexOf("icon-") != -1){
                            ulHtml += '<i class="seraph '+data[i].children[j].ImgUrl+'" data-icon="'+data[i].children[j].ImgUrl+'"></i>';
                        }else{
                            ulHtml += '<i class="layui-icon" data-icon="'+data[i].children[j].ImgUrl+'">'+data[i].children[j].ImgUrl+'</i>';
                        }
                    }
                ...
                if(data[i].target == "_blank"){
                    ulHtml += '<a data-url="'+data[i].LinkUrl+'" target="'+data[i].target+'">';
                }else{
                    ulHtml += '<a data-url="'+data[i].LinkUrl+'">';
                }
                if(data[i].ImgUrl != undefined && data[i].ImgUrl != ''){
                    if(data[i].ImgUrl.indexOf("icon-") != -1){
                        ulHtml += '<i class="seraph '+data[i].ImgUrl+'" data-icon="'+data[i].ImgUrl+'"></i>';
			...
			$("#top_tabs li").each(function(){
				if($(this).attr("lay-id") != '' && !$(this).hasClass("layui-this")){
					...
					for(var i=0;i<menu.length;i++){
						if($("#top_tabs li.layui-this cite").text() == menu[i].MenuName){
