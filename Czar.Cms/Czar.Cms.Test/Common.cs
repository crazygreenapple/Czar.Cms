   ...
   public class Common
    {
        ...
        public static IServiceProvider BuildServiceForSqlServer()
        {
            ...
            {
                options.ConnectionString = "server=.;Uid=sa;Pwd=123456;DataBase=Czar.Cms;";//这个必须
                ...
                options.OutputPath = @"D:\git\Cms\Czar.Cms\Czar.Cms.Models";//实体模型输出路径，为空则默认为当前程序运行的路径
